...
public class Blacksmith extends NPC implements Conversation{
    ...
    public String getBlacksmithMonologue() {
        return blacksmithMonologue.getRandomMonologue();
    }
    ...
    public String conversation(Actor actor) {
        ...
        if(actor.hasAttribute(Ability.HAS_GIANT_HAMMER)){
            ...
            blacksmithMonologue.addMonologue(monologueHasHammer);
        }
        ...
        if(!actor.hasAttribute(Status.ABXERVYER_DEFEATED)){
            blacksmithMonologue.addMonologue(monologueAbxNotDefeated);
        }
        ...
        if(actor.hasAttribute(Status.ABXERVYER_DEFEATED)){
            blacksmithMonologue.addMonologue(monologueAbxDefeated);
            blacksmithMonologue.removeMonologue(monologueAbxNotDefeated);
        }
