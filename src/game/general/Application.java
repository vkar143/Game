...
//        }
        ...
        abxervyerGameMap.at(29, 10).addActor(abxervyer);
        ...
        abxervyerGameMap.at(17, 6).addActor(new RedWolf());
        world.addPlayer(player, abxervyerGameMap.at(30, 10));
        abxervyerGameMap.at(30, 12).addActor(new Blacksmith());

        world.run();

//        GameManager gameManager = new GameManager(player, world);
